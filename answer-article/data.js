...
const articles = [
    ...
    {
        id: '5',
        title: '别慌，解决问题靠的不是聪明，而是闭环思维',
        category: 'philosophy',
        summary: '揭示解决问题的核心逻辑不是聪明而是闭环思维，教授从稳情绪到出结果再到长经验的完整闭环流程',
        date: new Date().toISOString().split('T')[0],
        views: 9532,
        likes: 765,
        questions: [
            {
                id: 'q1',
                question: '为什么我总被问题困住，找不到解决办法？根本原因是什么？',
                answer: '<p>根本原因通常不是能力、运气或问题难度，而是你缺乏一套系统化的解题逻辑。真正的高手靠的不是灵光一现，而是从"稳情绪"到"出结果"再到"长经验"的完整闭环流程。</p>'
            },
            {
                id: 'q2',
                question: '解决问题的核心"四步闭环法"是哪四步？',
                answer: '<p>这套环环相扣的方法是：</p><p>1. 冷静破局：先处理情绪，再处理问题。</p><p>2. 本质洞察：透过表象，找到问题的根本原因。</p><p>3. 执行落地：将方案拆解为可执行、可跟踪的具体动作。</p><p>4. 复盘迭代：从每次经历中提炼经验，转化为能力。</p>'
            },
            {
                id: 'q3',
                question: '为什么说"冷静"是解决问题的第一步？具体怎么做？',
                answer: '<p>因为情绪会劫持理性。问题来时，第一反应若是焦虑，思维就会瘫痪。</p><p>具体方法：</p><p>• 暂停10秒：深呼吸，让大脑从情绪模式切换回理性模式。</p><p>• 角色抽离法：想象是朋友遇到这事，你会怎么帮他分析？以此跳出当局者迷的困境。</p>'
            },
            {
                id: 'q4',
                question: '如何避免在问题的表面"瞎忙活"，找到本质原因？',
                answer: '<p>使用 "5Why分析法" ，连续追问多层"为什么"。</p><p>• 例子：孩子成绩差 → 为什么？作业错多 → 为什么？上课没听懂 → 为什么？老师方法不适合他 → 为什么没换方法？因为没人告诉他。本质是找到适合他的学习方法，而非一味批评。</p>'
            },
            {
                id: 'q5',
                question: '想到办法却总是"执行不力"，怎么办？',
                answer: '<p>你需要搭建 "三维执行引擎"：</p><p>• 拆解任务：将"提升业绩"拆解为"每周对接10个新客户"等具体、可衡量的小任务。</p><p>• 坚决推进：遇到拒绝不轻易放弃，而是记录原因，思考改进。</p><p>• 灵活调整：发现方法无效，果断调整策略，而非一条路走到黑。</p>'
            },
            {
                id: 'q6',
                question: '如何避免"同一个坑里摔两次"，把经历变成能力？',
                answer: '<p>关键在于复盘迭代。做完一件事后，走通这四步：</p><p>1. 对比：目标 vs 结果，差距在哪？</p><p>2. 分析：做得好的和不足的分别是什么？</p><p>3. 优化：下次同样情况，如何改进？</p><p>4. 迁移：这个经验还能用在什么地方？</p>'
            },
            {
                id: 'q7',
                question: '如何从今天开始练习这套方法？',
                answer: '<p>从最小的事情开始刻意练习：</p><p>• 练冷静：外卖送错了，先深呼吸10秒，再沟通。</p><p>• 练洞察：手机耗电快，连问三个"为什么"找到根本设置问题。</p><p>• 练执行：打扫房间也拆解成周六上午、下午的具体任务。</p><p>• 练复盘：写完报告，花5分钟总结一下优劣和改进点。</p>'
            }
        ]
    }
];
