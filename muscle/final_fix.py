...
# 备份文件
with open('data_backup_final.js', 'w', encoding='utf-8') as f:
    f.write(content)
print("已创建备份文件: data_backup_final.js")
...
# 替换所有匹配的肌肉条目
new_content = re.sub(pattern, add_images, content)
