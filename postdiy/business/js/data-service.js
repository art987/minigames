...
var BizLocalData = {
  ...
  // 行业大类（用于诊断匹配）
  majorIndustries: [
    { code: '餐饮', name: '餐饮美食', icon: 'utensils' },
    { code: '零售', name: '零售购物', icon: 'shopping-bag' },
    { code: '服务业', name: '生活服务', icon: 'briefcase' }
  ],

  // 行业小类（majorCategory 映射到大类，用于诊断过滤）
  industries: [
    { code: '通用', name: '通用', icon: 'star', majorCategory: '通用', group: '' },
    { code: '餐厅', name: '餐厅', icon: 'utensils', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '奶茶茶饮', name: '奶茶茶饮', icon: 'cup-soda', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '烧烤烤串', name: '烧烤烤串', icon: 'flame', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '火锅店', name: '火锅店', icon: 'soup', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '面馆小吃', name: '面馆小吃', icon: 'noodle', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '烘焙蛋糕', name: '烘焙蛋糕', icon: 'cake-slice', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '咖啡甜品', name: '咖啡甜品', icon: 'coffee', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '酒吧清吧', name: '酒吧清吧', icon: 'beer', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '西餐披萨', name: '西餐披萨', icon: 'pizza', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '早餐店', name: '早餐店', icon: 'croissant', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '包子铺', name: '包子铺', icon: 'steaming-bowl', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '麻辣烫', name: '麻辣烫', icon: 'cooking-pot', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '快餐简餐', name: '快餐简餐', icon: 'sandwich', majorCategory: '餐饮', group: '餐饮美食' },
    { code: '水果生鲜', name: '水果生鲜', icon: 'grape', majorCategory: '零售', group: '零售购物' },
    { code: '服饰鞋包', name: '服饰鞋包', icon: 'shirt', majorCategory: '零售', group: '零售购物' },
    { code: '饰品珠宝', name: '饰品珠宝', icon: 'gem', majorCategory: '零售', group: '零售购物' },
    { code: '母婴用品', name: '母婴用品', icon: 'baby', majorCategory: '零售', group: '零售购物' },
    { code: '美妆护肤', name: '美妆护肤', icon: 'lipstick', majorCategory: '零售', group: '零售购物' },
    { code: '数码家电', name: '数码家电', icon: 'smartphone', majorCategory: '零售', group: '零售购物' },
    { code: '药店药房', name: '药店药房', icon: 'pill', majorCategory: '零售', group: '零售购物' },
    { code: '绘画艺术', name: '绘画艺术', icon: 'palette', majorCategory: '服务业', group: '教育培训' },
    { code: '音乐乐器', name: '音乐乐器', icon: 'music', majorCategory: '服务业', group: '教育培训' },
    { code: '舞蹈培训', name: '舞蹈培训', icon: 'person-standing', majorCategory: '服务业', group: '教育培训' },
    { code: '学科辅导', name: '学科辅导', icon: 'book-open', majorCategory: '服务业', group: '教育培训' },
    { code: '武术跆拳道', name: '武术跆拳道', icon: 'sword', majorCategory: '服务业', group: '教育培训' },
    { code: '驾考培训', name: '驾考培训', icon: 'car', majorCategory: '服务业', group: '教育培训' },
    { code: '美容美甲', name: '美容美甲', icon: 'sparkle', majorCategory: '服务业', group: '美容健康' },
    { code: '美发造型', name: '美发造型', icon: 'scissors', majorCategory: '服务业', group: '美容健康' },
    { code: 'SPA养生', name: 'SPA养生', icon: 'flame-kindling', majorCategory: '服务业', group: '美容健康' },
    { code: '瑜伽健身', name: '瑜伽健身', icon: 'yoga', majorCategory: '服务业', group: '美容健康' },
    { code: '口腔眼科', name: '口腔眼科', icon: 'smile', majorCategory: '服务业', group: '美容健康' },
    { code: '汽车服务', name: '汽车服务', icon: 'car', majorCategory: '服务业', group: '生活服务' },
    { code: '房产装修', name: '房产装修', icon: 'home', majorCategory: '服务业', group: '生活服务' },
    { code: '家政保洁', name: '家政保洁', icon: 'sparkles', majorCategory: '服务业', group: '生活服务' },
    { code: '家电维修', name: '家电维修', icon: 'tv', majorCategory: '服务业', group: '生活服务' },
    { code: '家居办公', name: '家居办公', icon: 'sofa', majorCategory: '服务业', group: '生活服务' },
    { code: '建筑工程', name: '建筑工程', icon: 'hard-hat', majorCategory: '服务业', group: '生活服务' },
    { code: 'KTV娱乐', name: 'KTV娱乐', icon: 'mic', majorCategory: '服务业', group: '娱乐休闲' },
    { code: '电影网吧', name: '电影网吧', icon: 'clapboard', majorCategory: '服务业', group: '娱乐休闲' },
    { code: '桌游密室', name: '桌游密室', icon: 'dice-5', majorCategory: '服务业', group: '娱乐休闲' },
    { code: '儿童乐园', name: '儿童乐园', icon: 'ferris-wheel', majorCategory: '服务业', group: '娱乐休闲' },
    { code: '旅游酒店', name: '旅游酒店', icon: 'plane', majorCategory: '服务业', group: '娱乐休闲' },
    { code: '广告印刷', name: '广告印刷', icon: 'printer', majorCategory: '服务业', group: '其他行业' },
    { code: '茶叶烟酒', name: '茶叶烟酒', icon: 'leaf', majorCategory: '零售', group: '其他行业' },
    { code: '花店花卉', name: '花店花卉', icon: 'flower-2', majorCategory: '零售', group: '其他行业' },
    { code: '直播', name: '直播', icon: 'video', majorCategory: '服务业', group: '其他行业' },
    { code: '知识付费', name: '知识付费', icon: 'graduation-cap', majorCategory: '服务业', group: '其他行业' },
    { code: '运动休闲', name: '运动休闲', icon: 'target', majorCategory: '服务业', group: '其他行业' },
    { code: '心理咨询', name: '心理咨询', icon: 'brain', majorCategory: '服务业', group: '其他行业' },
    { code: '加油站', name: '加油站', icon: 'fuel', majorCategory: '服务业', group: '其他行业' }
  ],
