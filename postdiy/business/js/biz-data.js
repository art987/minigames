...
// ============================================================
chapters: [
  { id: 1, name: "选址定生死", icon: "map-pin", desc: "从地图到门店的决胜法则", color: "#E74C3C", subs: [
  ...
  { id: 9, name: "金点子", icon: "lightbulb", desc: "真实商家创意营销实战案例", color: "#FF9800", subs: [
  ...
  { id: 2, name: "产品为王", icon: "trophy", desc: "让顾客非买不可的选品逻辑", color: "#F39C12", subs: [
  ...
  { id: 3, name: "服务即营销", icon: "heart-handshake", desc: "把路人变成终身粉丝", color: "#E91E63", subs: [
  ...
  { id: 4, name: "流量破局", icon: "rocket", desc: "线上线下全渠道获客术", color: "#3498DB", subs: [
  ...
  { id: 5, name: "团队进化", icon: "users", desc: "小店的用人管人之道", color: "#9B59B6", subs: [
  ...
  { id: 6, name: "财务算盘", icon: "calculator", desc: "每一分钱都花在刀刃上", color: "#27AE60", subs: [
  ...
  { id: 7, name: "逆境求生", icon: "shield", desc: "淡季、竞争、危机的应对方案", color: "#F44336", subs: [
  ...
  { id: 8, name: "老板心法", icon: "brain", desc: "从生意人到企业家的认知跃迁", color: "#607D8B", subs: [
...
symptoms: {
  TRAFFIC_LOW: [
    { _id: "sym_t01", name: "工作日进店不足20人", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期","老店"] },
    { _id: "sym_t02", name: "门店周边500米内无明显客流来源", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_t03", name: "路过人群不进店，驻足率低", industryFilter: ["零售","服务业"], stageFilter: ["新店","成长期","老店"] },
    { _id: "sym_t04", name: "线上引流到店转化率低于5%", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_t05", name: "门前有流量但门头无吸引力", industryFilter: ["餐饮","零售"], stageFilter: ["新店","成长期"] },
    { _id: "sym_t06", name: "周末与工作日客流无明显差异", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["老店"] }
  ],
  REVENUE_DROP: [
    { _id: "sym_r01", name: "月营收连续3个月环比下降", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_r02", name: "客单价同比下降超过15%", industryFilter: ["餐饮","零售"], stageFilter: ["老店"] },
    { _id: "sym_r03", name: "高峰时段营收占比降低", industryFilter: ["餐饮","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_r04", name: "促销活动效果越来越差", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_r05", name: "新品/新服务贡献营收占比不足10%", industryFilter: ["零售","服务业"], stageFilter: ["成长期","老店"] }
  ],
  PROFIT_LOW: [
    { _id: "sym_p01", name: "毛利率低于行业平均水平", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期","老店"] },
    { _id: "sym_p02", name: "房租占营收比超过25%", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_p03", name: "食材/进货成本持续上涨", industryFilter: ["餐饮","零售"], stageFilter: ["成长期","老店"] },
    { _id: "sym_p04", name: "人工成本占比超过35%", industryFilter: ["餐饮","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_p05", name: "月净利润为负或低于营收5%", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期","老店"] }
  ],
  PRODUCT_SLOW: [
    { _id: "sym_s01", name: "核心单品月销量持续下滑", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_s02", name: "新品上市后一个月动销率不足30%", industryFilter: ["餐饮","零售"], stageFilter: ["成长期","老店"] },
    { _id: "sym_s03", name: "库存周转天数超过行业均值2倍", industryFilter: ["零售"], stageFilter: ["成长期","老店"] },
    { _id: "sym_s04", name: "客户反馈产品缺乏新意", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["老店"] },
    { _id: "sym_s05", name: "主推产品复购率低于15%", industryFilter: ["餐饮","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_s06", name: "产品结构单一，缺乏利润款", industryFilter: ["零售","服务业"], stageFilter: ["新店","成长期"] }
  ],
  CUSTOMER_LOSS: [
    { _id: "sym_c01", name: "月复购率低于20%", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_c02", name: "会员活跃度逐月下降", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_c03", name: "无客户回访和关怀机制", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_c04", name: "客户转介绍率几乎为零", industryFilter: ["零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_c05", name: "差评和投诉处理不及时", industryFilter: ["餐饮","服务业"], stageFilter: ["成长期","老店"] }
  ],
  STAFF_HARD: [
    { _id: "sym_h01", name: "员工月流失率超过15%", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期","老店"] },
    { _id: "sym_h02", name: "新员工培训周期超过2周仍无法独立上岗", industryFilter: ["餐饮","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_h03", name: "员工服务态度投诉频发", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_h04", name: "无明确绩效考核和激励制度", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_h05", name: "核心岗位依赖单一员工", industryFilter: ["餐饮","服务业"], stageFilter: ["成长期","老店"] }
  ],
  MARKETING_HARD: [
    { _id: "sym_m01", name: "从未做过线上营销推广", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_m02", name: "投放过广告但ROI低于1:2", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_m03", name: "公众号/抖音号粉丝不足500", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_m04", name: "不知道如何策划促销活动", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_m05", name: "口碑传播完全依赖自然发生", industryFilter: ["零售","服务业"], stageFilter: ["新店","成长期","老店"] },
    { _id: "sym_m06", name: "缺少可复制的获客渠道", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] }
  ],
  COMPETITION: [
    { _id: "sym_x01", name: "1公里内同类型商家超过5家", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期","老店"] },
    { _id: "sym_x02", name: "主要竞品价格比自己低20%以上", industryFilter: ["餐饮","零售"], stageFilter: ["成长期","老店"] },
    { _id: "sym_x03", name: "客户经常拿竞品做对比后离开", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["成长期","老店"] },
    { _id: "sym_x04", name: "缺乏差异化卖点，客户记不住你", industryFilter: ["餐饮","零售","服务业"], stageFilter: ["新店","成长期"] },
    { _id: "sym_x05", name: "竞品有品牌连锁优势，自己单店无力抗衡", industryFilter: ["餐饮","零售"], stageFilter: ["老店"] }
  ]
},
...
cases: [
  ...
  },
  {
    ...
    solution: "让顾客免费砸凳子验证质量，砸不坏就必须买，砸坏了白送。挑战过程极具观赏性，围观路人越聚越多。购买后还有额外奖励：介绍朋友来买送配件。凳子质量过硬，真正砸坏的比例极低，但挑战过程就是最好的广告——用行动证明质量。",
    effectData: "成交率提升60%，老客转介绍率翻倍",
    keyPoints: ["免费砸凳子验证质量", "砸不坏就买砸坏白送", "围观效应引流", "转介绍送配件"],
    steps: ["邀请顾客免费砸凳子验证质量", "砸不坏则购买，砸坏则白送", "挑战过程拍视频发抖音二次传播", "购买后介绍朋友来买送配件奖励"]
  },
  {
    _id: "case_g34",
    title: "卖鱼夹鸡蛋游戏",
    ...
    sub: 901,
    problem: "客流少、客单价低",
    solution: "先送鸡蛋引流：路过免费领鸡蛋，吸引人气。买鱼消费后可参与夹鸡蛋游戏，按消费额给不同时长：消费30元给15秒、消费50元给25秒、消费100元给30秒。在限定时间内用筷子夹鸡蛋，夹到几个送几个。鸡蛋成本极低但趣味性极强，顾客为了多夹一会儿会主动提高消费额。",
    effectData: "客单价提升45%，客流量增长30%",
    keyPoints: ["送鸡蛋引流", "消费额对应游戏时长", "筷子夹鸡蛋趣味性强", "时长分级促高消费"],
    steps: ["路过免费送鸡蛋吸引客流", "买鱼消费后按金额给不同游戏时长", "用筷子在限定时间夹鸡蛋，夹到送", "消费越高时间越长，激励提高客单价"]
  },
  {
    _id: "case_g35",
    title: "奶茶抽吸管活动",
    ...
    sub: 902,
    problem: "新客少、缺乏话题性",
    solution: "准备27根吸管三种颜色各9根，红色送免费奶茶、黄色送折扣券、蓝色送小礼品。顾客购买后随机抽一根，9/27概率中免费奶茶。三种颜色对应三种奖励，没有空奖。抽吸管的过程简单有趣，顾客抽到红色会兴奋分享，抽到黄色蓝色也不亏，下次还来。",
    effectData: "新客增长35%，社交媒体曝光量翻倍",
    keyPoints: ["27根吸管三种颜色", "9/27中免费奶茶", "三种奖励无空奖", "抽到大奖自然传播"],
    steps: ["准备27根吸管分三种颜色对应三种奖励", "购买奶茶后可抽一根吸管", "按颜色当场兑现奖励", "鼓励顾客拍照发朋友圈二次传播"]
  },
  {
    _id: "case_g36",
    title: "卖红薯飞镖挑战",
    ...
    solution: "设飞镖靶，不同环数对应不同奖励：外环送1个红薯、中环送2个、内环送半斤、靶心送一整袋。购买红薯后免费投3镖。飞镖挑战门槛低人人会玩，围观者看到有人中靶心就忍不住也想试试。红薯成本极低，但游戏体验让路人变成顾客。",
    effectData: "日销量提升50%，围观众转化为顾客比例达40%",
    keyPoints: ["飞镖不同环数对应不同奖励", "购买后免费投3镖", "红薯成本低奖励大方", "围观转化率高"],
    steps: ["设飞镖靶，标明不同环数对应奖品", "购买红薯后免费投3镖", "按环数兑现红薯奖励", "围观者拍照发圈二次引流"]
  },
  {
    _id: "case_g37",
    title: "卖鸡爪数字抽牌",
    ...
    sub: 902,
    problem: "复购低、顾客吃完就走",
    solution: "顾客购买鸡爪后先报一个1-10的数字，然后从对应数字位置的牌堆抽一张牌。抽到红心送半斤鸡爪、黑桃送折扣券、大王送免单、小王送会员卡。再叠加盲盒惊喜：鸡爪包装底部贴隐藏标签，中奖需会员才能兑奖。数字游戏+盲盒双重刺激，复购率飙升。",
    effectData: "复购率提升55%，会员转化率提升35%",
    keyPoints: ["报数字抽牌", "扑克牌对应不同奖励", "底部盲盒标签叠加", "中奖需会员兑奖锁客"],
    steps: ["顾客购买后报1-10的数字", "从对应位置抽牌按花色兑奖", "鸡爪包装底部贴隐藏标签", "盲盒中奖需办会员才能兑奖"]
  },
  {
    _id: "case_g38",
    title: "卖橘子袋子计价",
    ...
    sub: 905,
    problem: "按斤卖利润薄、客单价低",
    solution: "不按斤卖，15元一个袋子，25秒内装满归你。计时器大声倒计时，围观者看顾客手忙脚乱装橘子觉得有趣。旁边放按斤5元/斤的价格牌做对比，顾客心理觉得按袋划算。实际上25秒能装的量有限，但体验感和客单价都远超按斤卖。",
    effectData: "客单价提升40%，利润率提升25%",
    keyPoints: ["15元一袋25秒装满", "计时器增加紧张感", "按斤价格牌做对比", "体验感远超按斤卖"],
    steps: ["设15元一袋计时25秒的规则", "准备计时器和中等偏小的袋子", "旁边放按斤价格牌做对比", "装袋过程吸引围观二次引流"]
  },
  {
    _id: "case_g39",
    title: "卖菠萝锚定对比",
    ...
    sub: 905,
    problem: "顾客犹豫不决、成交率低",
    solution: "菠萝分三档定价：小号3元、中号4元、大号金枕10元。三款并排展示，大小差异一目了然。关键是改变提问方式——不问「要不要买菠萝」，而是问「买哪种菠萝」。顾客被引导做选择而非拒绝，大部分人选中号4元，因为比小号只多1元品质好很多，比大号便宜太多。",
    effectData: "成交率提升50%，中号菠萝销量占比达65%",
    keyPoints: ["三档定价3/4/10元", "问买哪种不问要不要", "10元高价款做锚点", "4元中号自然成首选"],
    steps: ["菠萝分三档定价并排展示", "训练店员问买哪种不问要不要", "把10元大号放在显眼位置做锚点", "观察顾客偏好灵活推荐"]
  },
  {
    _id: "case_g40",
    title: "早餐店引蛇出洞",
    ...
    sub: 903,
    problem: "客流少、新客进店率低",
    solution: "3元小米粥免费送，但只有会员才能免费领。19.9元办会员卡，一年内每天可免费喝小米粥。小米粥成本约1元，一年365元成本，但19.9元会员费已覆盖近20天成本，顾客不可能天天来，实际成本远低于理论值。关键是会员每天来喝粥时会顺手买包子油条，这才是利润来源。",
    effectData: "会员数月增200+，会员日均消费比非会员高60%",
    keyPoints: ["3元小米粥免费送引流", "19.9元会员年卡", "喝粥顺手买主食", "粥是鱼饵主食是利润"],
    steps: ["3元小米粥会员免费领", "19.9元办会员卡全年免费喝粥", "会员来喝粥时推荐包子油条", "微信群每天发早餐提醒促到店"]
  },
  {
    _id: "case_g41",
    title: "早餐店飞龙在天",
    ...
    solution: "打卡365天送电动车。顾客每天到店消费并打卡，连续打卡满365天送一辆电动车。电动车成本约2000元，但365天消费产生的利润远超2000元（按每天消费10元利润3元算，365天利润1095元，加上其他连带消费轻松覆盖）。真正打满365天的人极少，但所有人都被吸引来尝试。",
    effectData: "日均到店率提升40%，连续打卡30天以上顾客占30%",
    keyPoints: ["打卡365天送电动车", "必须消费才能打卡", "电动车成本被365天消费覆盖", "打卡进度可视化"],
    steps: ["设打卡365天送电动车活动", "每天消费后盖章打卡", "在店内设打卡墙展示进度", "定期公布坚持最久的顾客激励参与"]
  },
  {
    _id: "case_g42",
    title: "早餐店双龙戏珠",
    ...
    solution: "分时段免费送不同单品引流：7点前送豆浆、7-8点送鸡蛋、8-9点送小菜。不同时段不同免费品，把客流分散到全时段。同时鼓励顾客发短视频曝光，拍到店画面+门店定位发抖音送额外小食。免费品吸引到店，短视频扩大线上曝光，线下线上双龙戏珠。",
    effectData: "闲时客流提升70%，抖音曝光量月增5000+",
    keyPoints: ["分时段送不同免费品", "错峰引流分散客流", "拍短视频加定位送奖励", "线上曝光+线下到店双驱动"],
    steps: ["设计不同时段免费品策略", "每个时段限量供应控制成本", "顾客发短视频+定位送额外小食", "把门店打造成本地网红打卡点"]
  },
  {
    _id: "case_g43",
    title: "卖生蚝筷子夹挑战",
    ...
    sub: 901,
    problem: "生蚝销量平平、缺乏话题",
    solution: "15秒筷子夹生蚝挑战：用筷子在15秒内把生蚝从一个盘子夹到另一个盘子，夹完免费送全部，夹10个以上半价买。生蚝滑溜溜筷子难夹，极具挑战性和观赏性。围观者看别人夹不住就忍不住想试试，夹到的人欢呼庆祝，场面火爆。",
    effectData: "生蚝销量提升80%，围观转化率达35%",
    keyPoints: ["15秒筷子夹生蚝", "夹完免费夹10个半价", "生蚝滑溜极具挑战性", "围观者变参与者"],
    steps: ["设15秒筷子夹生蚝挑战", "夹完免费送夹10个以上半价", "挑战过程大声倒计时吸引围观", "拍视频发抖音二次传播"]
  },
  {
    _id: "case_g44",
    title: "卖月饼30秒吃光",
    ...
    solution: "30秒吃光月饼挑战：30秒内吃完指定月饼送188元月饼礼盒，吃不光则买一盒98元。月饼是干货很难快速吃完，挑战成功率低但观赏性极强。顾客挑战时的表情和动作天然搞笑素材，围观者笑声不断。挑战失败买一盒也不贵，成交自然。",
    effectData: "月饼季销量提升90%，活动期间日客流翻倍",
    keyPoints: ["30秒吃光送188元礼盒", "吃不光买一盒98元", "月饼干货难速食极具挑战", "搞笑场面天然传播素材"],
    steps: ["设30秒吃光月饼挑战", "成功送188元礼盒失败买98元一盒", "挑战过程拍搞笑视频发抖音", "设挑战榜单和纪录激励参与"]
  },
  {
    _id: "case_g45",
    title: "美容院天网人网地网",
    ...
    solution: "三网联动裂变：天网——把微信头像和签名本地化（XX区美容院+电话），让同城搜索到的人第一眼就知道你是谁；人网——九宫格锁客，老客带新客两人各享项目折扣，推荐3人送免费项目；地网——到店游戏参与（刮刮卡、幸运抽奖），转发朋友圈额外奖励。三网合一，线上曝光+老客推荐+到店转化全链路打通。",
    effectData: "新客月增长60%，老客转介绍率提升3倍",
    keyPoints: ["头像签名本地化做天网", "九宫格锁客老带新", "到店游戏+转发奖励做地网", "三网合一全链路裂变"],
    steps: ["微信头像签名改为本地化+电话", "设计九宫格锁客老带新享折扣", "到店设刮刮卡抽奖吸引参与", "转发朋友圈额外奖励扩大曝光"]
  },
  {
    _id: "case_g46",
    title: "面包挑战喝果汁",
    ...
    sub: 901,
    problem: "果汁销量低、产品单一",
    solution: "30秒吃面包挑战：30秒内吃完指定面包挑战成功免单，失败则买一杯西瓜汁。面包是干货很难快速吃完，挑战失败率极高，但失败买的是西瓜汁而非面包，巧妙把挑战失败转化成果汁销售。西瓜汁定价可适当提高（15-20元），面包成本仅2-3元，利润可观。",
    effectData: "果汁销量提升120%，整体利润率提升20%",
    keyPoints: ["30秒吃面包挑战", "失败买西瓜汁不买面包", "面包干货难速食失败率高", "果汁定价提高保证利润"],
    steps: ["设30秒吃面包挑战规则", "挑战失败买一杯西瓜汁", "西瓜汁定价适当提高", "挑战过程有趣味性吸引围观"]
  },
  {
    _id: "case_g47",
    title: "卖寿司挑战+裂变",
  ...
  },
  {
    ...
    sub: 901,
    problem: "客流少、缺乏爆点活动",
    solution: "能抓几瓶送几瓶：把啤酒瓶摆好，顾客单手抓啤酒，能抓起几瓶就送几瓶。抓4瓶以上老板倒立洗头！这个游戏人人会玩、规则极简、效果炸裂。抓1-2瓶轻松，3瓶有难度，4瓶以上极难但有可能，所以所有人想试。老板倒立洗头的噱头更是话题王，拍视频发抖音必火。",
    effectData: "活动期间客流翻3倍，抖音单条视频播放量10万+",
    keyPoints: ["单手抓啤酒能抓几瓶送几瓶", "4瓶以上老板倒立洗头", "规则极简人人会玩", "老板噱头天然爆款"],
    steps: ["摆好啤酒瓶设单手抓游戏", "能抓几瓶送几瓶当场兑现", "4瓶以上老板当场倒立洗头", "全程拍视频发抖音二次传播"]
  },
  {
    _id: "case_g50",
    title: "卖葡萄裂变营销",
    ...
    solution: "三重裂变组合拳：第一重——四人同行一人免单，4人一起买葡萄随机一人免单，免单相当于75折但比打折更有传播力；第二重——1元购11瓶果汁，果汁分11次到店领取，锁定11次到店；第三重——消费满520元退款，4人消费满520元退全款给发起人，刺激拼团凑单。三重叠加，裂变效果倍增。",
    effectData: "拼团订单占比达45%，客流量增长80%",
    keyPoints: ["四人同行一人免单", "1元11瓶果汁锁定11次到店", "满520元退款刺激拼团", "三重裂变叠加效果倍增"],
    steps: ["设四人同行一人免单活动", "叠加1元购11瓶果汁分次领取", "消费满520元退全款刺激凑单", "活动全程拍视频发社交媒体传播"]
  }
],
