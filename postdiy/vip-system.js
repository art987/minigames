...
const VIPSystem = (function() {
  ...
  function getDefaultVipPackages() {
    return [
      { _id: '', duration: 1, title: '1个月VIP', price: 9.9, originalPrice: 60, saving: '无限制下载次数', badge: '', featured: false, sortOrder: 1, promotionText: '', taobaoEnabled: false, taobaoUrl: '', taobaoPrice: 0 },
