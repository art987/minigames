...
function updateTypeTags(festival) {
  ...
  if (savedType && types.indexOf(savedType) !== -1) {
    ...
    if (savedTag) {
      ...
      window.currentFilters.type = savedType;
      setTimeout(function() { scrollTypeTagToView(savedTag); }, 100);
    }
  }
  ...
  function initHomePopup() {
    ...
    function setButtonBackground(button, type) {
      ...
      if (wrapper) {
        ...
        console.warn('[bg-set] 找不到 .button-wrapper:', button);
      }
    }
